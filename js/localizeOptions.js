function localizeOptions() {
	...
	document.querySelector("#save-button").innerHTML = chrome.i18n.getMessage("save");
	document.querySelector("#reset-button").innerHTML = chrome.i18n.getMessage("resettodefault");
	document.querySelector("#save-notice").innerHTML = chrome.i18n.getMessage("savenotice");
};
